<x-layout bodyClass="g-sidenav-show  bg-gray-200">
        <x-navbars.sidebar activePage="Data Keuangan"></x-navbars.sidebar>
        <main class="main-content position-relative max-height-vh-100 h-100vh border-radius-lg ">
            <!-- Navbar -->
            <x-navbars.navs.auth titlePage="Data Keuangan"></x-navbars.navs.auth>
            <!-- End Navbar -->
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                                    <h6 class="text-white text-capitalize ps-3">Data Keuangan</h6>
                                                ...
                                                <td class="align-middle">
                                                    <center>
                                                        <a rel="tooltip" class="btn btn-success btn-link"
                                                            href="/dashboard" data-original-title=""
                                                            title="">
